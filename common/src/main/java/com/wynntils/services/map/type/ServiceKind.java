...
public enum ServiceKind {
    ALCHEMISM_STATION("Alchemism Station", Texture.ALCHEMIST_STATION, "profession:alchemism", true),
    ARMOUR_MERCHANT("Armour Merchant", Texture.ARMOR_MERCHANT, "merchant:armor"),
    ARMOURING_STATION("Armouring Station", Texture.ARMORING_STATION, "profession:armoring", true),
    BLACKSMITH("Blacksmith", Texture.BLACKSMITH, "blacksmith"),
    BOOTH_SHOP("Booth Shop", Texture.BOOTH_SHOP, "booth-shop", true),
    COOKING_STATION("Cooking Station", Texture.COOKING_STATION, "profession:cooking", true),
    ...
    HOUSING_BALLOON("Housing Balloon", Texture.HOUSING_BALLOON, "housing-balloon", true),
    ...
    JEWELING_STATION("Jeweling Station", Texture.JEWELING_STATION, "profession:jeweling", true),
    ...
    PARTY_FINDER("Party Finder", Texture.PARTY_FINDER, "party-finder", true),
    POTION_MERCHANT("Potion Merchant", Texture.POTION_MERCHANT, "merchant:potion"),
    SCRIBING_STATION("Scribing Station", Texture.SCRIBING_STATION, "profession:scribing", true),
    ...
    TAILORING_STATION("Tailoring Station", Texture.TAILORING_STATION, "profession:tailoring", true),
    TOOL_MERCHANT("Tool Merchant", Texture.TOOL_MERCHANT, "merchant:tool", true),
    ...
    WEAPONSMITHING_STATION("Weaponsmithing Station", Texture.WEAPONSMITHING_STATION, "profession:weaponsmithing", true),
    WOODWORKING_STATION("Woodworking Station", Texture.WOODWORKING_STATION, "profession:woodworking", true);
    ...
    ServiceKind(String name, Texture texture, String mapDataId, boolean hiddenOnMap) {
        this.name = name;
        this.texture = texture;
        this.mapDataId = mapDataId;
